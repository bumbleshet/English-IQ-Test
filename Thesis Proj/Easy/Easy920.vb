Public Class Easy920
    ...
    Private Sub btnQuestion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnQuestion.Click
        ...
        counter = 0
        MessageBox.Show("Part II" + vbCrLf + "Hard 1-20 questions")
        Hard1.Show()
        Me.Close()
    End Sub
    ...
    Private Sub Easy920_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
